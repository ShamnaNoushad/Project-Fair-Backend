...
exports.getAllProjects = async(req,res)=>{
    ...
    const query ={
        language:{
            //regex = regular expression, and option i is given to avoid casesensitivity
            $regex:searchKey,
            $options:"i"
        }
    }
...
exports.editProject = async(req,res)=>{
    ...
    try{
        ...
        const updateProject = await projects.findByIdAndUpdate({_id:id},{title,language,
        github,link,overview,projectImage:uploadImage,userId},{new:true})
